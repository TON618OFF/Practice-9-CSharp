...
namespace Practice_9
{
    ...
    internal class Program
    {
        ...
        private static void Setup()
        {
            ...
            Console.Title = "Змеечка моя любимая :0 Хочу поиграть на нокиа 3310";
        ...
        private static void Draw()
        {
            ...
            {
                new string('x', _size.Width - 2).Write(1, i, ConsoleColor.DarkGray, ConsoleColor.Black);
            }

            _head.Write("0", ConsoleColor.Red, ConsoleColor.Black);
            _tail.Write("o");
